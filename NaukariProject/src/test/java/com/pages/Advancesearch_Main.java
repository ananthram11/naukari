...
public class Advancesearch_Main {
	...
	public void  enterdata() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"advFrm\"]/div[2]/div[1]/label")).click();
		driver.findElement(By.xpath("//*[@id=\"adv_jobCategory\"]")).click();
		WebElement d =driver.findElement(By.xpath("//*[@id=\"8\"]"));
		act.moveToElement(d).click().build().perform();
		driver.findElement(By.xpath("//*[@id=\"advFrm\"]/div[5]/div[2]/div/div[2]/a")).click();
		driver.findElement(By.xpath("//*[@id=\"advFrm\"]/div[6]/div[2]/div/div[2]/a")).click();
	}
